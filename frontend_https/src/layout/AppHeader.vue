            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <base-dropdown class="nav-item" menu-classes="dropdown-menu-xl">
                    ...
                    <div class="dropdown-menu-inner mt-2">
                        ...
                        <router-link to="/register"  class="media d-flex align-items-center" >
                ...
                <base-dropdown tag="li" class="nav-item">
                    ...
                    <router-link to="/profile" class="dropdown-item"><i class="ni ni-circle-08"></i>프로필</router-link>
                    <router-link to="/chat"  class="dropdown-item"><i class="ni ni-chat-round"></i>채팅</router-link>
                    <router-link to="/map" class="dropdown-item"><i class="ni ni-compass-04"></i>지도</router-link>
                    <router-link to="/averreg" class="dropdown-item"><i class="ni ni-archive-2"></i>점수등록</router-link>
                </base-dropdown>
                <li class="nav-item">

                        <span class="nav-link-inner--text d-lg-none" v-on:click="checking"><i class="mr-1"
